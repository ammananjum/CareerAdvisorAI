...
- **AI Model:** Jupyter Notebook with scikit-learn
- **Database:** MySQL
- **Other Tools:** GitHub, GitHub Desktop, Visual Studio 2022, VS Code
...
3. AI model predicts a career path based on the inputs
4. Result is shown on the screen
5. Users can also send contact messages
...
### Profile Form
![Profile Form](images/profileform.png)
...
> You may view, learn from, and improve this project for personal or academic use.  
